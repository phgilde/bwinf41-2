...
\section{Beispiele}
\subsection{Sortieren}
Die Beispiele \lstinline|pancake0.txt| bis \lstinline|pancake7.txt| sind direkt von den BwInf-Webseiten übernommen. Die Beispiele \lstinline|pancake2h.txt| bis \lstinline|pancake11h.txt|
sind die in der zweiten Teilaufgabe gefundenen aufwändigsten Pfannkuchenstapel mit Höhe 2-11. Die Beispiele sind im Ordner \lstinline|beispiele| zu finden.\\
Eingabe: \lstinline|pancake0.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
3 2 4 5 1
...
2 4 5
\end{lstlisting}
Eingabe: \lstinline|pancake1.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
6 3 1 7 4 2 5
...
1 2 4 6
\end{lstlisting}
Eingabe: \lstinline|pancake2.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
8 1 7 5 3 6 4 2
...
3 5 7 8
\end{lstlisting}
Eingabe: \lstinline|pancake3.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
...
2 3 5 10 11
\end{lstlisting}
Eingabe: \lstinline|pancake4.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
...
1 3 8 10 11 12
\end{lstlisting}
Eingabe: \lstinline|pancake5.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
...
1 2 3 5 6 9 10 13
\end{lstlisting}
Eingabe: \lstinline|pancake6.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
...
1 2 3 9 10 12 14
\end{lstlisting}
Eingabe: \lstinline|pancake7.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
...
\end{lstlisting}
Eingabe: \lstinline|pancake2h.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
2 1
...
1
\end{lstlisting}
Eingabe: \lstinline|pancake3h.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
2 3 1
...
1
\end{lstlisting}
Eingabe: \lstinline|pancake4h.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
1 4 3 2
...
1 2
\end{lstlisting}
Eingabe: \lstinline|pancake5h.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
1 4 2 5 3
...
2 3
\end{lstlisting}
Eingabe: \lstinline|pancake6h.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
1 5 6 3 2 4
...
2 5 6
\end{lstlisting}
Eingabe: \lstinline|pancake7h.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
1 6 2 7 3 5 4
...
5 6 7
\end{lstlisting}
Eingabe: \lstinline|pancake8h.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
4 8 1 6 2 7 5 3
...
1 6 7
\end{lstlisting}
Eingabe: \lstinline|pancake9h.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
1 8 2 6 9 3 7 5 4
...
5 7 8 9
\end{lstlisting}
Eingabe: \lstinline|pancake10h.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
...
1 3 7 8
\end{lstlisting}
Eingabe: \lstinline|pancake11h.txt| \\
Ausgabe:
\begin{lstlisting}
-- schritte --
